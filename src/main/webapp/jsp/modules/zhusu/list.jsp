            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">住宿表列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">住宿表列表</h3>
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('fjTypes')">住宿房间编号</th>
                                    <th onclick="sort('yhTypes')">住宿人</th>
                                    <th onclick="sort('initiateTime')">住宿开始时间</th>
                                    <th onclick="sort('finishTime')">住宿结束时间</th>
                                    <th onclick="sort('finishTime')">天数</th>
                                    <th onclick="sort('finishTime')">入住状态</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        var finishTimeCell = document.createElement('td');
        var sArr = item.initiateTime.split("-")
        ...
        var zhuangtCell = document.createElement('td');
        if(item.zhuangt == 1){
            zhuangtCell.innerHTML = "入住中";
        }else{
            zhuangtCell.innerHTML = "已退房";
        }
        row.appendChild(zhuangtCell);
        ...
        if(item.zhuangt == 1) {
            ...
            var deleteAttr = 'tuifang(' + item.id + ')';
    ...
    function tuifang(id) {
        ...
        if (mymessage == true) {
            http("zhusu/tuifang?ids="+id, "get", {}, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    // 退房
    function remove(id) {
        var mymessage = confirm("真的要删除吗？，删除后房间状态将会改为未入住");
        if (mymessage == true) {
            http("zhusu/delete?ids="+id, "get", {}, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "zhusu");
