    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">酒店商店表管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">酒店商店表管理</li>
                        <li class="breadcrumb-item active">酒店商店表列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">酒店商店表列表</h3>
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('name')">商品名称</th>
                                    <th onclick="sort('money')">商品价格</th>
                                    <th>商品图片</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">购买数量</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="num" name="num" type="number" class="form-control" value="1"
                                           onchange="moneyChickValue(this)" placeholder="商品购买数量">
                                </div>
                            </div>
                        </div>
                        </br>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="receive" class="btn btn-primary">购买</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        var detailBtn = document.createElement('button');
        var buttAttr = 'butt(' + item.id + ')';
        detailBtn.setAttribute("type", "button");
        detailBtn.setAttribute("class", "btn btn-success btn-sm 购买");
        detailBtn.setAttribute("data-toggle", "modal");
        detailBtn.setAttribute("data-target", "#exampleModal");
        detailBtn.setAttribute("onclick", buttAttr);
        detailBtn.innerHTML = "购买"
        btnGroup.appendChild(detailBtn)
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("shangdian/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    // 购买
    function receive(num,id) {
        var mymessage = confirm("真的要购买 "+num+" 件商品吗？");
        if (mymessage == true) {
            http("shangdian/receive?num="+num+"&id="+id, "get", {}, (res) => {
                if(res.code == 0)
            {
                getDataList();
                alert('购买成功');
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "shangdian");
