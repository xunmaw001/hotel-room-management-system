            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑房间预定表</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>是否到达</label>
                                       <select id="sfddTypesSelect" name="sfddTypes" class="form-control">
                                       </select>
                                   </div>
...
<script>
    ...
    function initializationSfddtypesSelect(){
        var sfddTypesSelect = document.getElementById('sfddTypesSelect');
            for (var i = 0; i < sfddTypesOptions.length; i++) {
                sfddTypesSelect.add(new Option(sfddTypesOptions[i].indexName,sfddTypesOptions[i].codeIndex));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        ...
        for (var i = 0; i < sfddTypesOptions.length; i++) {
            if(sfddTypesOptions[i].codeIndex == ruleForm.sfddTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("sfddTypesSelect").options[i].selected = true;
            }
        }
    }
