            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑财务表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">财务表信息</h3>
                            ...
                            <div class="form-row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="maxMoney" name="maxMoney" class="form-control"
                                            onchange="maxMoneyChickValue(this)" placeholder="花费金额">
                                 </div>
                                    <div class="form-group col-md-6">
                                        <label>花费时间</label>
                                        <input id="expenditureTime" name="expenditureTime" class="form-control"
                                                placeholder="花费时间" type="date">
                                    </div>
